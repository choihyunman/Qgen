        ...
        {Array.from(
          ...
          return (
            <button
              ...
              className={`aspect-square rounded-[12px] flex items-center justify-center text-sm font-medium relative transition-colors duration-200 ease-in-out min-w-[32px] cursor-pointer ${
