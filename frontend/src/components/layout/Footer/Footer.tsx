...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className={`flex flex-col  transition-opacity duration-500 ${expanded ? "gap-8" : ""}`}>
        <div className="flex justify-between ">
          {/* 왼쪽 */}
          <div>
            <div className={`${expanded ? "text-7xl font-extrabold mb-6 " : "text-3xl font-bold mb-2"}`}>
              Q-gen
            </div>
            {expanded && (
              <>
                ...
                <div className="text-gray-400 text-lg">
                  <span className="font-medium">이메일</span> | 4321rag@gmail.com
                </div>
              </>
            )}
          </div>
              ...
              <div>
                <div className="text-right font-bold text-xl mb-2">
                  ...
                  <span className="font-normal">
                    은 시험을 준비하는 응시자와 출제자를 위한 AI 기반 학습 플랫폼입니다.
                  </span>
                </div>
                <div className="text-right text-gray-300 text-md mb-2">
                  사용자가 업로드한 자료를 분석하여 개인화된 학습 콘텐츠와 문제를 제공합니다.<br />
                  다양한 형식의 자료(PDF, 이미지, URL 등)를 업로드하고, <br />
                  나만의 문제와 시험지를 만들고 망각곡선에 기반한 오답관리로 자격증 공부를 준비해보세요.
                </div>
              </div>
            ) : (
              <div className="flex flex-col items-end">
