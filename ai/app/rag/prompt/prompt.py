...
밑에 예시와 같이 question에서 부가 설명이 필요할 경우 \n\n과 \n를 통해서 줄바꿈을 해줘 

[
  {{
   "type":"TYPE_CHOICE",
    "question": "이와 같은 특징을 가진 소프트웨어 구성 요소는 무엇인가?\n\n ㆍ상호 독립적으로 작동하며 유지 보수성을 높인다.\nㆍ각기 다른 기능을 수행하는 프로그램 코드의 그룹이다.\nㆍ재사용이 용이하여 개발 속도를 향상시킬 수 있다.",
